...
/**
* Created by xieying on 2020-03-11.
* Description：
*/
public class CustomScrollView extends ViewGroup {
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		case MotionEvent.ACTION_MOVE: {
			...
			if (index < 0) {
				LogUtils.d("Error processing scroll; pointer index for id " + mScrollPointerId
